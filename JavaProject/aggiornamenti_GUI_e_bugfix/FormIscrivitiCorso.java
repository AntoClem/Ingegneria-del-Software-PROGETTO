...
/**
 * Boundary del caso d'uso IscrivitiCorso (UC6).
 *
 * GUI costruita "a mano" con GridBagLayout (equivalente funzionale di
 * quanto lo Swing UI Designer di IntelliJ avrebbe generato): non usa il
 * file .form proprietario del designer, quindi non sara' modificabile
 * visivamente in IntelliJ, ma il risultato compilato ed eseguito e'
 * identico. Se preferite comunque partire dal designer visuale,
 * cancellate il contenuto del costruttore da "JPanel contentPane..."
 * in poi e ricostruitelo con Palette -> JFrame Form.
 */
public class FormIscrivitiCorso extends JFrame {
    ...
    public FormIscrivitiCorso(Studente studenteLoggato) {
        ...
        txtCodiceCorso.addActionListener(e -> gestisciIscrizione()); // invio da tastiera
    }

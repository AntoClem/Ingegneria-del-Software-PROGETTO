...
/**
 * Boundary del caso d'uso PubblicaContenuto (UC7).
 * GUI costruita "a mano" con GridBagLayout, vedi nota in FormIscrivitiCorso.
 */
public class FormPubblicaContenuto extends JFrame {
    ...
    public FormPubblicaContenuto(Corso corsoSelezionato) {
        ...
        opzioniSezione[0] = null; // "nessuna sezione"

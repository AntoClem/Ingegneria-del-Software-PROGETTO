 ...
 * script schema.sql (contenuto in DesignModel/sql/schema.sql):
 * copiatelo in src/main/resources/schema.sql nel progetto Maven, cosi'
 * finisce sul classpath e questa classe puo' leggerlo con
 * getResourceAsStream. Le istruzioni CREATE TABLE IF NOT EXISTS lo
 * rendono idempotente: si puo' rieseguire ad ogni avvio senza
 * cancellare i dati gia' presenti.
 */
